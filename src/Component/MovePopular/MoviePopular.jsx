import {getMoviePopular, useGetMovies } from "../../Pages/useMovies";
...
export default function MoviePopular() {
  ...
  const { data } = useGetMovies(["moviePopular", page],getMoviePopular);
  ...
  return (
    <div className="container mt-3">
      <div className="row">
        <h2 className="pt-5 mt-2">Popular Movies</h2>
